...
// =======================================================Events=================================================
function personagem_page(position){
    historia.innerText = Personagens[position].historia
    nome.innerText = Personagens[position].name
    tipo.innerText = Personagens[position].tipoNem
    video.innerHTML = Personagens[position].video
    habilidades.innerText = Personagens[position].habilidades
    img.setAttribute ( 'src' , Personagens[position].foto)
 
    if(body.classList != " "){
        body.removeAttribute('class')
        body.classList.add(Personagens[position].class) 
    }else{
        body.classList.add = Personagens[position].class
    }
}
